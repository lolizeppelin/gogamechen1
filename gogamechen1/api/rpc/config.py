...
def list_game_opts():
    cfg.set_defaults(datadb_opts, datadb_user='gogamedb-rw', datadb_ro_user='gogamedb-ro')
    cfg.set_defaults(logdb_opts, datadb_user='gogamelog-rw', datadb_ro_user='gogamelog-ro')
    return  datadb_opts + logdb_opts
...
def list_gm_opts():
    cfg.set_defaults(datadb_opts, datadb_user='gogmdb-rw', datadb_ro_user='gogmdb-ro')
    return datadb_opts
...
def list_cross_opts():
    cfg.set_defaults(datadb_opts, datadb_user='gocross-rw', datadb_ro_user='gocross-ro')
    return datadb_opts
